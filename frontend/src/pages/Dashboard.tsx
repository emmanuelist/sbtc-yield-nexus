...
import { BarChart3, Zap, Settings, Shield, FileText, Plus } from "lucide-react";
...
import ProtocolDetails, {
  Protocols,
} from "@/components/Dashboard/ProtocolDetails";
import TaxReporting, {
  TaxReport,
  TaxSummary,
  YieldTransaction,
} from "@/components/Dashboard/TaxReporting";
...
export const Dashboard: React.FC<DashboardProps> = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "strategies" | "protocols" | "tax" | "settings"
  >("overview");
  const { walletAddress } = useAppContext();

  // Add this to your existing state declarations
  const [isStrategyModalOpen, setIsStrategyModalOpen] =
  ...
  const allocation: AllocationItem[] = [
    ...
    { protocol: "VELAR", percentage: 20, color: "bg-amber-500" },
  ...
  const protocolss: Protocols[] = [
    {
      ...
      logo: "/alex-logo.png",
      description:
        "ALEX is a DeFi protocol built on Stacks, offering liquidity pools, yield farming, and staking services for sBTC and other Stacks assets.",
    ...
    },
    {
      ...
      description:
        "Bitflow is a yield optimizer for sBTC, automatically compounding rewards across multiple protocols to maximize returns.",
    ...
    },
    {
      ...
      logo: "/VELAR-logo.png",
      description:
        "VELAR is a decentralized lending protocol on Stacks, allowing users to provide liquidity and earn yield on sBTC and other assets.",
      ...
      riskLevel: 2,
      riskFactors: ["Smart contract risk", "Liquidation risk"],
      supported: true,
    },
  ...
  const alerts: Alert[] = [
    {
      ...
      message:
        "ALEX sBTC-USDA pool APY has dropped by 12% in the last 24 hours.",
      priority: 1,
    ...
    },
    {
      ...
      message:
        "0.0023 sBTC rewards ready to harvest from Bitflow Leverage Vault.",
      priority: 2,
    ...
    },
    {
      ...
      message: "VELAR launched a new sBTC-STX liquidity pool with 10.5% APY.",
      priority: 3,
  ...
  const protocols: Protocol[] = [
    ...
    {
      id: "apy-3",
      name: "VELAR", // changed from 'protocol' to 'name'
      symbol: "A",
      pool: "sBTC-xUSD",
      apy: 7.6,
        ...
        <div className="border-b border-gray-200 mb-6 overflow-x-auto">
          <nav className="flex space-x-8" aria-label="Dashboard Tabs">
            <button
              ...
              className={`py-3 border-b-2 font-medium text-sm transition-colors whitespace-nowrap ${
                activeTab === "overview"
          ...
          {activeTab === "overview" && (
            <>
              ...
              <div className="lg:col-span-8 space-y-6">
                ...
                {/* APY Leaderboard */}
                <APYLeaderboard protocols={protocols} />
              </div>

...
const STRATEGIES = [
  {
    ...
    protocols: ["ALEX Stable Pools", "VELAR Treasury"],
  ...
  },
  {
    ...
    protocols: ["Bitflow Yield Farms", "ALEX LP", "VELAR Vaults"],
...
const PROTOCOLS = [
  {
    ...
    description:
      "Automated liquidity exchange offering yield farming and options",
  },
  {
    id: "bitflow",
    name: "Bitflow",
...
export const YieldStrategySection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const maxValue = Math.max(...projectedReturns, ...holdReturns) * 1.1; // Add 10% padding
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0l25.98 15v30L30 60 4.02 45V15L30 0zm-5.98 10l-15 8.66v17.32l15 8.66 15-8.66V18.66l-15-8.66z' fill='%234f46e5' fill-opacity='0.4' fill-rule='evenodd'/%3E%3C/svg%3E\")",
            ...
            {Array.from({ length: 4 }).map((_, i) => (
              <div
                ...
                style={{
                  ...
                  animation: `spin-slow-${i % 2 === 0 ? "normal" : "reverse"} ${
                    70 + i * 20
                  }s linear infinite`,
                }}
              ></div>
            ...
            {Array.from({ length: 5 }).map((_, i) => {
              ...
              return (
                <path
                  ...
                  style={{
                    animation: `dash-animation ${10 + i * 5}s linear infinite ${
                      i * 2
                    }s`,
                    opacity: 0.5,
                  }}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10 lg:mb-12">
            ...
            <p className="text-base lg:text-lg text-gray-600 max-w-2xl mx-auto">
              Maximize your sBTC returns with our powerful strategy builder.
            ...
            >
              <div className="px-4 md:px-6 lg:px-8 pt-6">
                <TabsList className="w-full grid grid-cols-2 mb-6 bg-indigo-50/50 p-1 rounded-lg shadow-inner shadow-indigo-100/50">
                  <TabsTrigger
                    value="preset"
                    className="text-sm md:text-base data-[state=active]:bg-gradient-to-r data-[state=active]:from-indigo-500 data-[state=active]:to-violet-500 data-[state=active]:text-white data-[state=active]:shadow-md transition-all duration-200"
                  >
                    Preset Strategies
                  </TabsTrigger>
                  <TabsTrigger
                      ...
                      >
                        ...
                        <div className="p-4">
                          <div className="flex items-start">
                            <div
                              className={`mr-3 ${strategy.color} bg-opacity-10 p-1.5 rounded-lg inline-block transform transition-transform group-hover:scale-110 group-hover:rotate-3`}
                            >
                              {strategy.icon}
                            </div>
                            <div>
                          ...
                          <div className="mt-3 flex justify-between items-center">
                            ...
                            <span
                              className={`text-sm font-semibold ${strategy.color} group-hover:scale-110 transition-transform`}
                            >
                              {strategy.apy}
                            </span>
                          </div>
                        ...
                        <div className="md:w-1/2">
                          ...
                          <div className="bg-white/80 border border-indigo-100 rounded-lg p-3 shadow-sm">
                            ...
                            <div className="text-gray-700 text-sm">
                              <span className="font-semibold">0.5 sBTC</span>{" "}
                        ...
                        {PROTOCOLS.map((protocol) => (
                          ...
                          >
                            <div className="flex items-center mb-1.5">
                              ...
                              <div>
                                <h5 className="text-gray-900 font-medium text-sm">
                                  {protocol.name}
                                </h5>
                                <div className="flex items-center">
                                  <span className="text-xs text-gray-500 mr-2">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span
                                className={`font-semibold text-xs ${
                                  getReturnsDifference() > 0
                                    ? "text-green-600"
                                    : "text-red-600"
                                }`}
                              >
                                {getReturnsDifference() > 0 ? "+" : ""}
                                {getReturnsDifference().toFixed(2)}%
                              </span>
                            </div>
                            <div className="flex justify-between items-center">
                              <span className="text-gray-700 text-xs">

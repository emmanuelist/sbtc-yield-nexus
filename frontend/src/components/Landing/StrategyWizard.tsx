...
export const StrategyWizard: React.FC<StrategyWizardProps> = ({ onClose }) => {
  ...
  const presetStrategies = [
    {
      ...
      risk: 1,
      detail:
        "Focuses on stablecoin pools and protocols with strong security audits",
    ...
    },
    {
      ...
      risk: 5,
      detail:
        "Utilizes leverage and concentrated positions for maximum returns",
  ...
  const getEstimatedApy = () => {
    if (strategyType === "preset") {
      ...
      const selectedProtocolList = protocols.filter((p) =>
      ...
      <div className="max-h-[90vh] overflow-y-auto overflow-x-hidden p-6 scrollbar-thin scrollbar-thumb-indigo-200 scrollbar-track-blue-50">
        <DialogHeader className="border-b border-indigo-200/30 pb-4">
          ...
          <DialogDescription className="text-indigo-700">
            Create, simulate, and deploy a professional yield strategy tailored
                  ...
                  {presetStrategies.map((strategy) => (
                    ...
                    >
                      ...
                      <div className="mt-4 flex items-center">
                        <span className="text-sm text-indigo-500 mr-3">
                          Risk Level:
                        </span>
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 border border-indigo-200/30 rounded-lg p-4">
                    <p className="text-indigo-700 text-sm">
                      Design your own custom yield strategy by selecting the
                      protocols you want to include in your portfolio and
                      configuring their allocation in the next step.
                    </p>
                  </div>
                    ...
                    {protocols.map((protocol) => (
                      ...
                      >
                        ...
                        <div className="mt-3 flex items-center ml-10">
                          <span className="text-sm text-indigo-500 mr-2">
                            Risk Level:
                          </span>
                          <div className="flex space-x-1.5">
                            {[1, 2, 3, 4, 5].map((level) => (
          ...
          <div className="mt-10 space-y-8">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent className="bg-white border-indigo-200 text-indigo-900">
                          <p className="w-56 text-sm">
                            Higher risk levels may yield higher returns but come
                            with increased volatility and potential for loss.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                ...
                <span className="px-3 py-1 bg-indigo-100 border border-indigo-200/50 rounded-full text-sm font-medium text-indigo-700">
                  {riskLevel}/5
                </span>
              </div>
              <Slider
              ...
              >
                <div className="flex items-center p-3 space-x-3 border border-indigo-100 rounded-lg hover:border-indigo-300 transition-all duration-200 bg-white">
                  <RadioGroupItem
                    value="daily"
                    id="daily"
                    className="data-[state=checked]:border-indigo-500 data-[state=checked]:bg-indigo-600"
                  />
                  <div>
                    <Label
                      htmlFor="daily"
                    ...
                    <p className="text-xs text-indigo-500 mt-1">
                      Most responsive to market changes, higher gas costs
                    </p>
                  </div>
                </div>
                <div className="flex items-center p-3 space-x-3 border border-indigo-100 rounded-lg hover:border-indigo-300 transition-all duration-200 bg-white">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-indigo-500 mt-1">
                      Balanced approach between responsiveness and efficiency
                    </p>
                  </div>
                </div>
                <div className="flex items-center p-3 space-x-3 border border-indigo-100 rounded-lg hover:border-indigo-300 transition-all duration-200 bg-white">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-indigo-500 mt-1">
                      Lower gas fees, less frequent updates
                    </p>
                  </div>
                </div>
              </RadioGroup>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-2">
                <Input
                  ...
                  value={investment}
                  onChange={(e) =>
                    setInvestment(parseFloat(e.target.value) || 0)
                  }
                  placeholder="0.00"
                  min="0.01"
                  step="0.01"
              ...
              <div className="flex items-center text-sm text-indigo-500">
                ...
                Available Balance:{" "}
                <span className="text-indigo-900 ml-1 font-medium">
                  0.842 sBTC
                </span>
              </div>
            </div>
        ...
        {step === 3 && (
          <div className="mt-10 space-y-6">
            <div className="bg-white border border-indigo-100 rounded-xl p-5 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between py-2 border-b border-indigo-100">
                  ...
                  <div className="flex items-center">
                    <span className="text-indigo-900 font-medium mr-2">
                      {riskLevel}/5
                    </span>
                ...
                <div className="flex justify-between py-2 border-b border-indigo-100">
                  ...
                  <span className="text-indigo-900 font-medium capitalize">
                    {rebalanceFrequency}
                  </span>
                </div>
                <div className="flex justify-between py-2 border-b border-indigo-100">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-700 mt-1">
                    Deploying this strategy will require a wallet signature to
                    approve the initial deposit. Your funds remain non-custodial
            ...
            <div className="bg-white border border-indigo-100 rounded-xl p-5 relative overflow-hidden shadow-sm">
              ...
              <h3 className="text-lg font-medium text-indigo-900 mb-4 relative z-10">
              ...
              <div className="h-48 bg-indigo-50/50 rounded-lg flex items-center justify-center text-indigo-400 border border-indigo-100 relative z-10">
                ...
                <div className="w-full h-full p-4 flex items-end justify-between">
                  <div className="h-full flex items-end space-x-4 w-full">
                    {[30, 45, 42, 50, 65, 60, 75, 70, 85, 82, 90].map(
                      (height, i) => (
                        <div
                          key={i}
                        ...
                        >
                          ...
                          />
                          <div className="absolute -top-6 text-xs text-indigo-500">
                            {i === 5 ? "6mo" : i === 10 ? "12mo" : ""}
                          </div>
                        </div>
                      )
